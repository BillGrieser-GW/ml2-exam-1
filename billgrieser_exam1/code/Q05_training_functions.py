...
def make_training_run(this_hidden_size, learning_rate, run_device, criterion=nn.CrossEntropyLoss(), 
    ...
    return net, loss, time.time() - start_time, optimizer
...
if __name__ == "__main__":
    ...
    for arch in hidden_size:
        for opt in optimizers:
            ...
            # Make a run
            net, loss, duration, optimizer = make_training_run(arch, 
                                          learning_rate=learning_rate, 
                                          run_device=run_device, 
                                          optimizer_function=opt)
            
            # Show/Store the results
            record_test_results(net, run_device, loss, duration, optimizer)
